...
Stage 34A adds a repo-local GOV.UK style skill for public, officer and cabinet-facing prose. It is useful for clearer writing, but it is not official GOV.UK/GDS endorsement, not legal assurance, not accessibility certification, not user testing, not professional sign-off and not readiness evidence.

Stage 35A adds officer-friendly DOCX files and a ZIP pack for the OBC simulation. It is useful for sharing and comment workflows, but it is not an official OBC, not officer advice, not consultation material, not procurement authority and not readiness evidence.
...
- Stage 34A GOV.UK style skill adoption exists, but it does not prove official GOV.UK/GDS endorsement, legal assurance, accessibility certification, user-tested comprehension, professional assurance, public-authority approval or readiness;
- Stage 35A OBC DOCX pack exists, but it does not prove official document-control approval, officer advice, consultation material, procurement authority, professional assurance, public-authority approval or readiness;
...
| OBC DOCX pack user | `business_case/obc/docx-pack/bristol-wpl-obc-document-pack.zip` | Stage 35A shareable Word pack; simulation-only and not official distribution |
| OBC DOCX support guide | `business_case/obc/docx-pack/bristol-wpl-obc-reader-support-guide.docx` | Word guide for non-technical readers |
| OBC DOCX pack QA maintainer | `scripts/validate_obc_docx_pack.py` | Checks ZIP contents and no-reliance wording |
| GOV.UK style skill user | `skills/govuk-style/SKILL.md` | Stage 34A plain-English writing control; not legal, accessibility or readiness assurance |
| GOV.UK style QA maintainer | `scripts/validate_govuk_style_skill.py` | Checks Stage 34A skill wiring and no-overclaim references |
