...
| Claim summaries | Current claim matrix covered; future drafting claims open | GREEN for current-matrix coverage control only, AMBER for drafting reliance | Stage 16A creates summaries for `CLM-0001` to `CLM-0038`; Stage 32A adds `CLM-0039`; EG-0045 remains open | Add or update claim summaries for every new OBC, FBC, consultation, statutory or public/officer claim before reliance |
...
| GOV.UK style skill | Repo-local public/officer writing skill exists | GREEN for writing-control only / AMBER for reliance | Stage 34A records the GOV.UK style skill. `ISS-0044`, `EG-0062` and `RISK-0047` remain open controls; the skill is not official GOV.UK/GDS endorsement, legal assurance, accessibility certification, user-tested comprehension, professional assurance or WPL readiness evidence. | Use `skills/govuk-style/SKILL.md`, `analysis/content/stage-34a-govuk-style-application.md` and `scripts/validate_govuk_style_skill.py`; obtain user testing accessibility review legal review and officer review before relying on public-facing material |
| OBC DOCX pack | Shareable Word files and ZIP exist for the simulation OBC | GREEN for document-pack control only / RED for reliance | Stage 35A records the DOCX pack. `ISS-0045`, `EG-0063` and `RISK-0048` remain open controls; the pack is not an official OBC, not officer advice, not consultation material, not procurement authority, not professional assurance and not WPL readiness evidence. | Use `business_case/obc/docx-pack/bristol-wpl-obc-document-pack.zip`, `business_case/obc/docx-pack/bristol-wpl-obc-reader-support-guide.docx` and `scripts/validate_obc_docx_pack.py`; obtain real officer legal accessibility records-management and document-control review before external reliance |
...
| Stage 34A records a bounded GOV.UK style skill for public and officer prose. | Not that GOV.UK/GDS endorsed the repo, that wording is legally assured, accessibility certified, user-tested or professionally signed off, or that readiness has changed. |
| Stage 35A records a DOCX and ZIP pack for easier sharing. | Not that the pack is official, officer-approved, consultation-ready, procurement-ready, document-control assured or WPL-ready. |
...
- Stage 34A GOV.UK style skill: `skills/govuk-style/SKILL.md`
- Stage 34A application record: `analysis/content/stage-34a-govuk-style-application.md`
- Stage 35A OBC DOCX pack ZIP: `business_case/obc/docx-pack/bristol-wpl-obc-document-pack.zip`
- Stage 35A OBC DOCX reader guide: `business_case/obc/docx-pack/bristol-wpl-obc-reader-support-guide.docx`
- Stage 35A OBC DOCX risk/process summary: `business_case/obc/docx-pack/bristol-wpl-obc-risk-process-control-summary.docx`
...
- Stage 34A gate report: `review/stage_gate_reports/stage-34a-govuk-style-skill-adoption-report.md`
- Stage 35A gate report: `review/stage_gate_reports/stage-35a-obc-docx-pack-report.md`
