# Source Note: SRC-BCC-0029

Status: Simulation-only source note. Stage 15A expanded cohort.
Source: Part 3.2 - Terms of Reference of Committees.
Local source: `evidence/raw/bristol-city-council/src-bcc-0029_part-3-2-terms-of-reference-of-committees-november-2025.pdf`
...
- Governance-route mapping for Bristol decision controls, committee remit, officer delegations or access-to-information rules.
- Identifying which constitutional source should be cross-read before any order-maker or signatory route claim.
- Testing whether a proposed decision route needs Monitoring Officer simulation review and later human legal review.
