# Source Note: SRC-BCC-0027

Status: Simulation-only source note. Stage 15A expanded cohort.
Source: Appendix B - Equality Impact Assessment - Workplace Parking Levy reviewed Oct 2025.
Local source: `evidence/raw/bristol-city-council/src-bcc-0027_src-bcc-0027-appendix-b-equality-impact-assessment-workplace-parking-levy-reviewed-oct-202.pdf`
...
- Evidence trail for equality-risk identification and how equality issues were framed at this point in the Bristol WPL work.
- Comparison against earlier or later EqIA material, where the source date and stage are kept visible.
- Identification of equality questions that require a later final EqIA, consultation response analysis and legal review.
