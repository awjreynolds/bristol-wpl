# Source Note: SRC-BCC-0011

Status: Simulation-only source note. Stage 15A expanded cohort.
Source: Public reports pack - Transport and Connectivity Policy Committee.
Local source: `evidence/raw/bristol-city-council/src-bcc-0011_public-reports-pack-transport-connectivity-policy-committee-2025-10-23.pdf`
Source register status: `downloaded_raw_omitted_from_public_repo`.
Workstream: `bristol_governance`.
Accessed date: 2026-06-25.

## What This Source Can Support

- Cross-checking the relevant Bristol committee pack, appendix set and public-meeting context using the registered source URL, hash and extracted/redacted text controls.
- Identifying whether committee papers, public forum material or appendices need separate source notes before being cited in a business case.
- Maintaining traceability for raw public PDFs omitted from the public repository after the hosted scanner detector-collision incident.
...
- The registered raw PDF is deliberately omitted from the public repository after the Stage 14B hosted-scanner detector-collision incident. Use the source URL, hash, extracted/redacted text and reacquisition controls before raw-binary reliance.
