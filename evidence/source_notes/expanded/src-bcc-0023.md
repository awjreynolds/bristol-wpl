# Source Note: SRC-BCC-0023

Status: Simulation-only source note. Stage 15A expanded cohort.
Source: Decision notice - Transport and Connectivity Policy Committee 23 October 2025.
Local source: `evidence/raw/bristol-city-council/src-bcc-0023_src-bcc-0023-decision-notice-transport-and-connectivity-policy-committee-23-october-2025.pdf`
...
- Formal public decision-trail chronology for the specific meeting and WPL item recorded by the notice.
- Distinguishing resolved decisions from officer recommendations and later assumptions.
- Checking whether downstream stage claims rely on a decision notice rather than a report-only source.
