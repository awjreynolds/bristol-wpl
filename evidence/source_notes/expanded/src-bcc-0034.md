# Source Note: SRC-BCC-0034

Status: Simulation-only source note. Stage 15A expanded cohort.
Source: Part 4.2 - Access to Information Procedure Rules.
Local source: `evidence/raw/bristol-city-council/src-bcc-0034_part-4-2-access-to-information-procedure-rules-may-2024.pdf`
...
- Bristol governance chronology and source-provenance checking for the WPL simulation.
- Identifying what the source can evidence directly at its publication date.
- Triangulation with decision notices, minutes, reports and constitution sources before drafting reliance.
