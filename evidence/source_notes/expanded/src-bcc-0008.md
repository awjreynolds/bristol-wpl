# Source Note: SRC-BCC-0008

Status: Simulation-only source note. Stage 15A expanded cohort.
Source: Workplace Parking Levy Update.
Local source: `evidence/raw/bristol-city-council/src-bcc-0008_committee-report-workplace-parking-levy-update-2025-05-15.pdf`
...
- Bristol governance chronology and officer-report framing for the WPL programme at the source date.
- Separating officer recommendations, background narrative and reported progress from actual committee resolutions.
- Testing whether later business-case prose cites a committee report only for what that report can evidence.
