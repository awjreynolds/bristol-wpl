# Source Note: SRC-BCC-0022

Status: Simulation-only source note. Stage 15A expanded cohort.
Source: Printed minutes - Transport and Connectivity Policy Committee 12 September 2024.
Local source: `evidence/raw/bristol-city-council/src-bcc-0022_src-bcc-0022-printed-minutes-transport-and-connectivity-policy-committee-12-september-2024.pdf`
...
- Meeting-record chronology, member discussion context and confirmation of how the WPL item was treated at that meeting.
- Triangulation with the decision notice and committee report for the same or adjacent meeting.
- Identifying whether a claimed decision is actually supported by the recorded minutes.
