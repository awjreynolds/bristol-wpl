---
document_id: ANALYSIS-LEGAL-LEGAL-AUTHORITY-AND-GOVERNANCE-MAP
title: Legal Authority And Governance Map
...
source_markdown: analysis/legal/legal-authority-and-governance-map.md
generated_outputs: []
build_id: ''
source_commit: ''
...
# Legal Authority And Governance Map
...
Stage 2E is recorded in `analysis/weca-role-and-evidence/stage-2e-weca-mca-role-classification.md`. It controls WECA/MCA language as strategic context and possible conditional funding/assurance context only. It does not confirm consent, no-role, transferred-function, formal support, formal objection or funding approval.
...
| Does WECA/MCA have transferred, concurrent, consent, funding, assurance or no direct WPL role? | Not settled. Stage 2E controls current evidence as strategic context and possible conditional funding/assurance context only. It does not prove formal approval, rejection, consent, sponsorship, funding, objection, transferred WPL function or no-role status. Current scoped sources do not support a transferred or concurrent WECA/MCA WPL function, but current-law no-role and no-consent conclusions remain blocked. | `SRC-WECA-0001`, `SRC-WECA-0003`, `SRC-WECA-0004`, `SRC-WECA-0006`, `SRC-WECA-0007`, `SRC-WECA-0011` to `SRC-WECA-0016`, `SRC-LEG-0009`, `SRC-LEG-0010`, `SRC-LEG-0014`, `SRC-LEG-0016`, `SRC-LEG-0022`, `SRC-LEG-0023` | P0 narrowed_open | No route conclusion that excludes or requires WECA/MCA. |
...
| Who operates licensing/enforcement? | Must follow the confirmed licensing authority or joint-scheme arrangement. The 2009 Regulations create PCN, representation, appeal, recovery and service controls. | `SRC-LEG-0011` | P1 open | Operations procedure and templates required before consultation/FBC readiness. |
| What did Bristol approve in September 2024? | Stage One Development and OBC work, option testing, CAZ-funded development costs, and Stage 1 procurement/contract authority. It did not approve implementation, FBC, statutory consultation launch, boundary, charge, threshold or exemptions. | `SRC-BCC-0004`, `SRC-BCC-0022` | accepted control | Governance chronology may be used only with this qualification. |

## Bristol Governance Evidence

The September 2024 decision notice and minutes evidence approval to progress Stage One Development and OBC work at up to GBP 1m, to test options, and to enable a more informed later decision on whether to proceed to FBC and potential delivery. They also evidence CAZ funding treatment and delegated procurement/contract authority for Stage 1 work. They do not evidence any implementation decision, FBC approval, statutory consultation launch, preferred boundary, charging level, employer threshold, exemptions package or statutory submission.
...
WECA/MCA evidence supports strategic context and possible funding/assurance interfaces only. Stage 2E controls this wording but does not close the current-law role. JLTP4 discusses demand management and workplace-parking-levy-type schemes as possible regional policy tools. WECA bus and BSIP sources reference WPL/demand management as policy/funding context. The assurance framework is relevant if any MCA or Single Pot/CRSTS-funded transport package interface is used. None of those sources is formal WECA/MCA approval, consent, support, objection or statutory-route confirmation for a Bristol WPL.

WECA/MCA constitution material is now acquired in `SRC-WECA-0011` to `SRC-WECA-0013`. It records broad transport, local-transport-plan, transport-operations, funding and decision-procedure material, but it does not expressly decide Bristol WPL approval, consent or no-role status. `SRC-WECA-0007` provides the current assurance framework if MCA funding or programme assurance is engaged. `SRC-WECA-0014` to `SRC-WECA-0016` provide public transport and committee-route context only.

`SRC-LEG-0010` and `SRC-LEG-0014` amend the West of England Combined Authority Order 2017, including omission of Part 3 transport in the extracted source. `SRC-LEG-0022` and `SRC-LEG-0023` confirm the current revised article pages carry that Part 3 omission note. `SRC-LEG-0016` confirms transport and local infrastructure as a strategic-authority area of competence under the 2026 Act. These are current-law mapping inputs, not a completed WPL function conclusion. `SRC-LEG-0015` is explicitly not a WPL power source; it concerns charges for works in maintainable highways and is retained only to avoid future misclassification.

## DfT / Secretary Of State Distinction

DfT pre-application engagement may be used to test dossier expectations, policy evidence expectations, timetable and submission format. It must be classified as informal officer engagement, policy expectation, procedural requirement, formal decision or confirmation material. No DfT engagement may be treated as statutory confirmation unless the formal decision-maker, power and confirmed order are evidenced. Stage 2B reduces the DfT/Secretary of State confusion risk from P0 to a controlled P1, but it does not make the statutory submission ready.

## Stage 2 Gate Finding

Stage 2 may proceed only as a technical legal/governance baseline. It does not authorise simulated preferred scheme design, statutory consultation preparation, OBC recommendation, FBC readiness, operations readiness or statutory submission.
...
- Complete legal mapping of acquired Bristol and WECA/MCA current constitution/delegation sources.
- DfT pre-application engagement evidence and classification.
- Scheme order contents matrix.
- Net-proceeds accounting policy, 10-year general plan and 5-year detailed programme.
- PCN, representation, appeal, recovery, service and data-protection operating procedures.
